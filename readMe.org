...
*** add schema contracts
    ...
    problem: how to match [:circle Circle]
    schema feels awkward for describing tagged data

    how to describe [:triangle p1 p2 p3]

    alternatively, how about making more use of complex numbers
    and their ability to be transformed
